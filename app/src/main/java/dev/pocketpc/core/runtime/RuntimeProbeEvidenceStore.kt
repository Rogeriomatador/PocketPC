...
class RuntimeProbeEvidenceStore(context:Context) {
 ...
 companion object { private const val PREFS="runtime-probe-evidence-v7";private const val KEY_BOX64="box64-smoke-key";private const val KEY_DISPLAY_BRIDGE="display-bridge-smoke-key";private const val KEY_WINE="wine-smoke-key";private const val KEY_D3D11="d3d11-smoke-key";private const val KEY_D3D11_PRESENT="d3d11-present-smoke-key";private const val KEY_WINDOWS_PROCESS="windows-process-ipc-smoke-key";private const val KEY_WINSOCK="winsock-smoke-key";private const val KEY_WINMM_AUDIO="winmm-audio-api-smoke-key";private const val KEY_RAW_INPUT="raw-input-api-smoke-key" }
}
